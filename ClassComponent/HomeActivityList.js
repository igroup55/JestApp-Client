...
export default class HomeActivityList extends Component {
  ...
  async componentDidMount () {
    ////tar2 - url צריך לשנות אחרי שמעדכנים ל tar 1
      ...
      const apiStationsUrl ='http://proj.ruppin.ac.il/igroup55/test2/tar2/api/ModuleActivity?UserID='+this.state.UserID;
      ...
      <Container style={styles.LastOperations}>
        ...
        <Content>
          ...
          {/* <ActivityIndicator style={{marginTop:150}} size="large" color="#A7D489" /> */}
            <TouchableOpacity>
            {this.state.ActivityList.length>1?(Activities): <Image style={{width:200,height:150,alignSelf:'center',marginTop:80}} source={{ uri: 'https://i.gifer.com/FpSr.gif'}} />}
              {/* {Activities} */}
            </TouchableOpacity>
